...
import { Upload, ChevronLeft, LogOut, ChevronDown, ChevronUp, Filter } from "lucide-react";
        ...
        >
          ...
          >
            <Input
              ...
              placeholder="Type Demographic Here..."
              className="bg-transparent border-none text-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-white/10 text-xl py-4 px-4 h-16"
              onKeyPress={(e) => {
                if (
                  e.key === "Enter" &&
                  prompt.trim() &&
                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div className="space-y-2">
                      <label className="text-sm text-white/70 font-medium">Income Range</label>
                    ...
                    {/* Race */}
                    <div className="space-y-2">
                      <label className="text-sm text-white/70 font-medium">Race/Ethnicity</label>
                    ...
                    {/* Age Range */}
                    <div className="space-y-2">
                      <label className="text-sm text-white/70 font-medium">Age Range</label>
                    ...
                    {/* Education Level */}
                    <div className="space-y-2">
                      <label className="text-sm text-white/70 font-medium">Education Level</label>
                    ...
                    {/* Marital Status */}
                    <div className="space-y-2">
                      <label className="text-sm text-white/70 font-medium">Marital Status</label>
                    ...
                    {/* Children */}
                    <div className="space-y-2">
                      <label className="text-sm text-white/70 font-medium">Children</label>
                    ...
                    {/* Home Ownership */}
                    <div className="space-y-2">
                      <label className="text-sm text-white/70 font-medium">Home Ownership</label>
                    ...
                    {/* Vehicle Ownership */}
                    <div className="space-y-2">
                      <label className="text-sm text-white/70 font-medium">Vehicle Ownership</label>
                    ...
                    {/* Industry */}
                    <div className="space-y-2">
                      <label className="text-sm text-white/70 font-medium">Industry</label>
                    ...
                    {/* Employment Status */}
                    <div className="space-y-2">
                      <label className="text-sm text-white/70 font-medium">Employment Status</label>
                    ...
                    {/* Work Schedule */}
                    <div className="space-y-2">
                      <label className="text-sm text-white/70 font-medium">Work Schedule</label>
                    ...
                    <div className="space-y-2">
                      <label className="text-sm text-white/70 font-medium">Political Affiliation</label>
                    ...
                    {/* Religion */}
                    <div className="space-y-2">
                      <label className="text-sm text-white/70 font-medium">Religion</label>
                    ...
                    {/* Language */}
                    <div className="space-y-2">
                      <label className="text-sm text-white/70 font-medium">Primary Language</label>
                    ...
                    {/* Hobbies */}
                    <div className="space-y-2">
                      <label className="text-sm text-white/70 font-medium">Primary Hobbies</label>
                      <Select value={hobbies} onValueChange={setHobbies}>
                        <SelectTrigger className="bg-transparent border-white/20 text-white">
                    ...
                    {/* Social Media Usage */}
                    <div className="space-y-2">
                      <label className="text-sm text-white/70 font-medium">Social Media Usage</label>
                      <Select value={socialMediaUsage} onValueChange={setSocialMediaUsage}>
                        ...
                        <SelectContent className="bg-gray-900 border-gray-700">
                          ...
                          <SelectItem value="minimal">Minimal User</SelectItem>
                    ...
                    {/* Shopping Behavior */}
                    <div className="space-y-2">
                      <label className="text-sm text-white/70 font-medium">Shopping Behavior</label>
                      <Select value={shoppingBehavior} onValueChange={setShoppingBehavior}>
                        <SelectTrigger className="bg-transparent border-white/20 text-white">
                          <SelectValue placeholder="Select shopping behavior" />
                        </SelectTrigger>
                        <SelectContent className="bg-gray-900 border-gray-700">
                          <SelectItem value="online">Online Shopper</SelectItem>
                          <SelectItem value="in-store">In-Store Shopper</SelectItem>
                          <SelectItem value="mixed">Mixed</SelectItem>
                          <SelectItem value="bargain-hunter">Bargain Hunter</SelectItem>
                          <SelectItem value="luxury">Luxury Shopper</SelectItem>
                    ...
                    {/* Brand Loyalty */}
                    <div className="space-y-2">
                      <label className="text-sm text-white/70 font-medium">Brand Loyalty</label>
                      <Select value={brandLoyalty} onValueChange={setBrandLoyalty}>
                        <SelectTrigger className="bg-transparent border-white/20 text-white">
                          <SelectValue placeholder="Select brand loyalty" />
                        </SelectTrigger>
                        <SelectContent className="bg-gray-900 border-gray-700">
                          <SelectItem value="high">High Loyalty</SelectItem>
                          <SelectItem value="moderate">Moderate Loyalty</SelectItem>
                          <SelectItem value="low">Low Loyalty</SelectItem>
                          <SelectItem value="brand-switcher">Brand Switcher</SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
                    ...
                    {/* Tech Savviness */}
                    <div className="space-y-2">
                      <label className="text-sm text-white/70 font-medium">Tech Savviness</label>
                      <Select value={techSavviness} onValueChange={setTechSavviness}>
                        <SelectTrigger className="bg-transparent border-white/20 text-white">
                    ...
                    <div className="space-y-2">
                      <label className="text-sm text-white/70 font-medium">Health Consciousness</label>
                      <Select value={healthConsciousness} onValueChange={setHealthConsciousness}>
                        <SelectTrigger className="bg-transparent border-white/20 text-white">
                    ...
                    <div className="space-y-2">
                      <label className="text-sm text-white/70 font-medium">Environmental Concern</label>
                      <Select value={environmentalConcern} onValueChange={setEnvironmentalConcern}>
                        <SelectTrigger className="bg-transparent border-white/20 text-white">
                    ...
                    {/* Travel Frequency */}
                    <div className="space-y-2">
                      <label className="text-sm text-white/70 font-medium">Travel Frequency</label>
                      <Select value={travelFrequency} onValueChange={setTravelFrequency}>
                        ...
                        <SelectContent className="bg-gray-900 border-gray-700">
                          ...
                          <SelectItem value="regular">Regular Traveler</SelectItem>
                          <SelectItem value="occasional">Occasional Traveler</SelectItem>
                          <SelectItem value="rare">Rare Traveler</SelectItem>
                    ...
                    {/* Dining Preferences */}
                    <div className="space-y-2">
                      <label className="text-sm text-white/70 font-medium">Dining Preferences</label>
                      <Select value={diningPreferences} onValueChange={setDiningPreferences}>
                        <SelectTrigger className="bg-transparent border-white/20 text-white">
                    ...
                    <div className="space-y-2">
                      <label className="text-sm text-white/70 font-medium">Entertainment Preferences</label>
                      <Select value={entertainmentPreferences} onValueChange={setEntertainmentPreferences}>
                        <SelectTrigger className="bg-transparent border-white/20 text-white">
                    ...
                    {/* Fitness Level */}
                    <div className="space-y-2">
                      <label className="text-sm text-white/70 font-medium">Fitness Level</label>
                    ...
                    {/* Sleep Pattern */}
                    <div className="space-y-2">
                      <label className="text-sm text-white/70 font-medium">Sleep Pattern</label>
                      <Select value={sleepPattern} onValueChange={setSleepPattern}>
                        <SelectTrigger className="bg-transparent border-white/20 text-white">
                    ...
                    {/* Stress Level */}
                    <div className="space-y-2">
                      <label className="text-sm text-white/70 font-medium">Stress Level</label>
                    ...
                    {/* Risk Tolerance */}
                    <div className="space-y-2">
                      <label className="text-sm text-white/70 font-medium">Risk Tolerance</label>
                    ...
                    {/* Communication Style */}
                    <div className="space-y-2">
                      <label className="text-sm text-white/70 font-medium">Communication Style</label>
                    ...
                    <div className="space-y-2">
                      <label className="text-sm text-white/70 font-medium">Decision Making Style</label>
                      <Select value={decisionMakingStyle} onValueChange={setDecisionMakingStyle}>
                        <SelectTrigger className="bg-transparent border-white/20 text-white">
                    ...
                    {/* Values */}
                    <div className="space-y-2">
                      <label className="text-sm text-white/70 font-medium">Core Values</label>
                    ...
                    {/* Lifestyle */}
                    <div className="space-y-2">
                      <label className="text-sm text-white/70 font-medium">Lifestyle</label>
                    ...
                    {/* Personality Type */}
                    <div className="space-y-2">
                      <label className="text-sm text-white/70 font-medium">Personality Type</label>
