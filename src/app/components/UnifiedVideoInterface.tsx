...
interface UnifiedVideoInterfaceProps {
...
export function UnifiedVideoInterface({
    uploadedVideo,
    onVideoUpload,
    targetAudience,
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen px-8 py-12 relative">
            ...
            >
                ...
                {/* Target Audience Section - Always visible */}
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                ...
                >
                    ...
                    >
                        <textarea
                            ...
                            onChange={(e) =>
                                onTargetAudienceChange(e.target.value)
                            }
                ...
                {/* Personas Count Section - Always visible */}
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                ...
                >
                    ...
                    <div className="px-2">
                        ...
                        <div className="flex justify-between text-xs text-gray-500 mt-2">
                            <span>10</span>
                            <span>Range: 10-500 personas</span>
                            <span>500</span>
                        </div>
                    </div>
                </motion.div>
            ...
            >
                <div className="text-xs text-white/40 backdrop-blur-sm bg-black/20 px-3 py-1 rounded-full border border-white/10">
