...
const generatePersonas = (): PersonaNode[] => {
    ...
    return personaTemplates.map((template, index) => {
        ...
        return {
            ...
            feedback: `Great potential for ${template.industry.toLowerCase()} applications. The approach resonates well with ${
                template.generation
            } audiences.`,
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-20">
                ...
                >
                    ...
                    <motion.div
                        ...
                        style={{
                            background:
                                "linear-gradient(135deg, #6EE7B7 0%, #2563EB 50%, #A855F7 100%)",
                ...
                >
                    ...
                    <motion.div
                        ...
                        transition={{
                            duration: 1.5,
                            repeat:
                                selectedNode?.id === persona.id ? Infinity : 0,
                        }}
                    />
